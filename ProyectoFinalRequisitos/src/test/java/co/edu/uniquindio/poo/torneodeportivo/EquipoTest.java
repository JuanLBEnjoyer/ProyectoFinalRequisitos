...
public class EquipoTest {
    ...
    public void nombreEquipoRepetido() {
        ...
        var equipo = new Equipo("Uniquindio", representante, new LinkedList<>(), GeneroEquipo.MASCULINO);
        var equipo2 = new Equipo("Uniquindio", representante, new LinkedList<>(), GeneroEquipo.MASCULINO);
        torneo.registrarEquipo(equipo);
    ...
    public void inscripcionCerrada() {
        ...
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().minusDays(1), (byte)24, (byte)0, 0,TipoTorneo.LOCAL,Genero.MIXTO,juez);
    ...
    public void inscripcionNoAbierta() {
        ...
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().plusDays(1), LocalDate.now().plusDays(15), (byte)24, (byte)0, 0,TipoTorneo.LOCAL,Genero.MIXTO,juez);
